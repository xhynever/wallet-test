...
# MIGRATIONS
up:
	@goose -dir ./repository/migrations postgres "postgresql://user:password@localhost:${DB_PORT}/db?sslmode=disable" up

down:
	@goose -dir ./repository/migrations  postgres "postgresql://user:password@localhost:${DB_PORT}/db?sslmode=disable" down
...
mock:
	...
	# MIGRATIONS
upDoc:
	@goose -dir ./repository/migrations postgres "postgresql://user:password@0.0.0.0:${DB_PORT}/db?sslmode=disable" up

downDoc:
	@goose -dir ./repository/migrations  postgres "postgresql://user:password@0.0.0.0:${DB_PORT}/db?sslmode=disable" down
